...
<body>
  ...
  <div class="row">
    ...
    <div class="">
      ...
      <div class="caption">
      <h2 align="center"><font color="#db6c0a"> Ficha </font></h2>

      <form action="fichapdf.php" method="POST">
...
<div class="row">
      ...
      <div class="form-group">
        <p> <label> Ficha </label> 
          <select name="s_ficha" id="s_ficha" class="btn btn-default dropdown-toggle" required>
            <option value=""> Seleccione una ficha </option>
              <?PHP
                $consultap ="SELECT DISTINCT cod_ficha  FROM ficha ORDER BY 1";
                $resultadoProducto=mysqli_query($conexion,$consultap) or die('Error');
